...
.setFooter("Savaşçı Team • Sizin Sayenizde Güzelleşiyorum...", client.user.avatarURL)
.setColor("#F0F2F3")
...
client.on('guildCreate', guild => {
const embed = new Discord.RichEmbed()
.setTitle(`Savaşçı Team | Bilgilendirme`)
.setColor(`09f7df`)
.setDescription(`**Merhaba!**\nBotumuzu Eklediğiniz İçin Teşekkür Ederiz!,Sizler Sayesinde Büyük Yerlere Geliyoruz.Eğer Hala Beni Eklemeyen Varsa Hala Geç Değil.\n\nKomutlara Bakmak İçin \`s!yardım\`\nBotu Davet Etmek İçin \`s!davet\`\n\n`)// <#734173047749345381>
guild.createChannel('savasciteam-bilgilendirme', {type: 'text'}).then(channel => channel.send(embed))
})
//-----------------------------------------ROL KORUMA--------------------\\
